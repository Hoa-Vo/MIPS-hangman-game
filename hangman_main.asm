     ...
     _checkOutWord:
              ...
              loopCheckOutWord:
                  ...
                  con2:
                      addi $a1,$a1,1
                      lb $t3,($a1)
                      beq $t3,0,endCheckOutWord1 #neu tu ran het  ki tu thi 2 tu khac nhau
                      addi $a1,$a1,-1 #nguoc lai lui lai mot byte da cong
                      addi $t0,$t0,-1 #lui lai de xet den ki tu * o loop1
                  loop1:
                      sub $t5,$zero,$t5 
